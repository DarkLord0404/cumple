...
{
    protected $fillable = ['name', 'slug', 'contact_email', 'is_active', 'reminders_enabled', 'reminder_days', 'overdue_alerts_enabled', 'review_alerts_enabled', 'approval_policy', 'minute_template_path', 'minute_template_name'];
